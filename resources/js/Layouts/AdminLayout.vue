    ...
    <div class="min-h-screen bg-gray-50 dark:bg-surface-950 flex">
        ...
        >
            ...
            <div class="flex items-center gap-3 px-5 py-5 border-b border-gray-100 dark:border-white/5">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-primary-500 to-accent-purple flex items-center justify-center shadow-glow flex-shrink-0">
                    <span class="text-white font-bold text-sm">P</span>
                </div>
                <div>
                    <div class="font-display font-bold text-gray-900 dark:text-white text-sm">Portfolio</div>
        ...
        <div class="flex-1 lg:ml-64 flex flex-col min-h-screen">
            ...
            <!-- Topbar -->
            <header class="sticky top-0 z-30 bg-white/80 dark:bg-surface-900/80 backdrop-blur-xl border-b border-gray-100 dark:border-white/5">
                <div class="flex items-center gap-4 px-4 lg:px-6 py-3.5">
                    ...
                    <h1 class="font-display font-semibold text-gray-900 dark:text-white text-lg">
                        {{ pageTitle }}
                    </h1>
                    ...
                    <div class="ml-auto flex items-center gap-3">
                        ...
                        <!-- Admin avatar -->
                        <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-primary-500 to-accent-purple flex items-center justify-center text-white text-sm font-bold shadow-glow">
                            A
                        </div>
                    </div>
                </div>
            ...
            <Transition name="flash">
                ...
                >
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path v-if="flash.success" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
...
const pageTitle = computed(() => {
    ...
    return Object.entries(titles).find(([k]) => url.startsWith(k))?.[1] ?? 'Admin'
})
...
const navGroups = computed(() => [
    ...
    },
    {
        label: 'Communication',
        items: [
            { href: '/admin/messages', icon: '✉️', label: 'Messages', badge: unreadCount.value || null },
        ],
    },
    {
        label: 'Configuration',
